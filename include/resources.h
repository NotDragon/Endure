...
std::map<char *, Texture2D> statIcons;
std::map<char *, Texture2D> characterAnimationIdle;
std::map<char *, Texture2D> characterAnimationWalk;
std::map<char *, Texture2D> buttons;
std::map<char *, Texture2D> playerUI;
std::map<char *, Texture2D> particles;

std::map<char *, int> items;

std::map<char *, std::vector<Texture2D>> enemyIdle;
std::map<char *, std::vector<Texture2D>> enemyWalk;

std::map<char *, Sound> fx;
